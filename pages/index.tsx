  ...
  return (
    <>
      ...
      <main className='text-white'>
        <section className='flex flex-col justify-center w-full px-6 pt-12 pb-20 text-center md:mx-auto md:px-16 md:pt-20 md:max-w-4xl lg:max-w-7xl'>
          <div className="text-center flex flex-col items-center mx-auto lg:w-full lg:flex-row">
            <div className='lg:text-left'>
              <h1 className="text-3xl font-bold mb-4 leading-10 mt-10 md:text-5xl lg:b-8 lg:my-3">
              ...
              <div className="flex flex-col gap-4 w-full md:flex-row md:w-auto md:justify-center">
                <button className='w-full py-4 bg-purple rounded-lg hover:bg-purple transition-colors mt-10 md:w-fit md:px-5 md:py-3'>
                  Contactez nous
                </button>
              </div>
            </div>
        ...
        {/* <Banner /> */}
        <section>
          <section className='flex flex-col items-center mx-6 my-28 md:mx-16
          '>
            <h2 className='text-3xl font-semibold md:text-4xl lg:text-4xl'>Pourquoi nous ?</h2>
            <p className='text-sm text-grey-200 pt-12 text-center md:text-base lg:text-lg'>Nous sommes spécialisés dans le design et le développement web pour les petites et moyennes entreprises. <br /><br />
          ...
          <section className='flex flex-col mx-6 my-28 md:mx-16 md:text-base lg:max-w-7xl lg:flex lg:flex-row lg:mx-auto lg:items-center'>
            <div>
              <h2 className='text-xl font-semibold lg:text-3xl'>Nous nous occupons de <strong className='text-lightPurple font-semibold'>tout.</strong></h2>
              <p className='text-sm text-grey-200 pt-6 md:text-base lg:text-lg lg:pr-20'>Vous n’avez pas le temps de vous occuper de votre site web, et c’est bien normal. Nous concevons, déployons et maintenons votre site web autant de temps que vous le souhaiterez. Modifications illimitées, sans engagement.</p>
            </div>
            <img className='mt-10 md:max-w-xl md:mx-auto lg:m-auto' src="/images/chill_and_work.webp" alt="Deux illustrations 3D côte à côte, une avec un homme qui se repose sur son transat, l'autre en train de travailler." />
          </section>
          <section className='flex flex-col mx-6 my-28 md:mx-16 md:text-base lg:max-w-7xl lg:flex lg:flex-row-reverse lg:mx-auto lg:items-center'>
            <div className='lg:pl-20'>
              <h2 className='text-xl font-semibold lg:text-3xl'>Des sites web <strong className='text-lightPurple font-semibold'>mémorables.</strong></h2>
              <p className='text-sm text-grey-200 pt-6 md:text-base lg:text-lg'>En adoptant les dernières tendances du webdesign ainsi que l’illustration 3D, votre site web sera à la pointe de la modernité.
            ...
            <img className='mt-10 md:max-w-xl md:mx-auto' src="/images/design.webp" alt="Deux illustrations 3D côte à côte, une avec un " />
          </section>
          <section className='flex flex-col mx-6 my-28 md:mx-16 md:text-base lg:max-w-7xl lg:flex lg:flex-row lg:mx-auto lg:items-center'>
            <div>
              <h2 className='text-xl font-semibold lg:text-3xl'>Chaque ligne de code est <strong className='text-lightPurple font-semibold'>écrite à la main.</strong></h2>
              <p className='text-sm text-grey-200 pt-6 md:text-base lg:text-lg'>Cela assure la meilleure performance possible et permet d’attirer plus de clients sur votre site, et donc de vous rapporter plus de revenus. Nous garantissons également que votre site sera accessible pour tous et naturellement bien classé sur Google.</p>
            </div>
            <img className='mt-10 md:max-w-xl md:mx-auto' src="/images/lighthouse.webp" alt="3 indicateurs, le premier est performances avec 97%, les deux autres sont accessibilité et SEO à 100%." />
          </section>
        </section>
        <section className='bg-grey-700 my-28 px-6 py-8 md:px-16 lg:rounded-3xl lg:max-w-7xl lg:py-16 lg:mx-auto'>
          <div className='flex flex-col lg:max-w-4xl lg:mx-auto'>
            <h2 className='text-3xl font-semibold text-center lg:text-4xl'>0€ d’accompte, 150€ par mois.
              <br />
              <strong className='text-lightPurple font-semibold'>Sans engagement.</strong>
            </h2>
            <p className='text-sm text-grey-200 pt-14 md:text-base lg:text-center lg:text-lg'>
            ...
            <section className='pt-8 grid grid-cols-1 my-6 gap-y-12 md:text-base md:gap-x-8 md:grid-cols-2'>
              <div className='flex flex-row'>
                <img className='object-cover h-12 lg:pr-2' src="/images/tools.webp" alt="Clé à molette et crayon l'un sur l'autre en 3D." />
                <div className='mx-2'>
                  <h3 className='mt-3 lg:text-xl'>Modifications illimitées</h3>
                  <p className='text-sm text-grey-200 pt-4 lg:text-lg'>Demandez autant de modifications que vous le souhaitez. Même si vous souhaitez refaire complètement le site.</p>
                </div>
              </div>
              <div className='flex flex-row'>
                <img className='object-cover h-12 lg:pr-2' src="/images/server.webp" alt="Serveurs avec un bouclier devant, en 3D." />
                <div className='mx-2'>
                  <h3 className='mt-3 lg:text-xl'>Frais d’hébergement inclus</h3>
                  <p className='text-sm text-grey-200 pt-4 lg:text-lg'>Les frais d’hébergements et de nom de domaines sont inclus dans l’abonnement.</p>
                </div>
              </div>
              <div className='flex flex-row'>
                <img className='object-cover h-12 lg:pr-2' src="/images/communication.webp" alt="Une bulle jaune qui sort d'un téléphone, avec un smiley heureux dessus." />
                <div className='mx-2'>
                  <h3 className='mt-3 lg:text-xl'>Joignables 7j/7</h3>
                  <p className='text-sm text-grey-200 pt-4 lg:text-lg'>Pas de standardiste ou de chatbot, vous pouvez nous contacter à tout moment par mail ou téléphone, et obtenir une réponse tout de suite.
                    La même personne sera avec vous tout le long de la collaboration.</p>
                </div>
              </div>
              <div className='flex flex-row'>
                <img className='object-cover h-12 lg:pr-2' src="/images/barchart.webp" alt="Un graph en 3D avec 5 barres, qui est en augmentation." />
                <div className='mx-2'>
                  <h3 className='mt-3 lg:text-xl'>Outils d’analyses</h3>
                  <p className='text-sm text-grey-200 pt-4 lg:text-lg'>Nous installons gratuitement des outils comme Google Analytics et Facebook Pixel afin de surveiller le traffic et sa provenance.</p>
                </div>
              </div>
            </section>
          </div>
        </section>
        <section className='flex flex-col my-16 mx-6 md:px-16 lg:max-w-5xl lg:mx-auto'>
          <h2 className='text-3xl font-semibold text-center lg:text-4xl'>Comment je peux être sûr que vos sites sont de bonne qualité ?</h2>
          <p className='text-sm text-grey-200 pt-14 md:text-base lg:text-lg lg:text-center'>
        ...
        <section className='flex flex-col my-16 mx-6 pt-16 md:px-16 lg:py-20'>
          <h2 className='text-3xl font-semibold text-center lg:text-4xl'>Qui sommes-nous ?</h2>
          <div className='lg:flex lg:flex-row lg:max-w-6xl lg:mx-auto lg:mt-16'>
            <div className='flex flex-col items-center mt-8 lg:m-0 lg:mr-16'>
              <img className='object-fit h-40 w-40 rounded-full' src="/images/avatar.webp" alt="Une photo de Quentin C., devant un fond bleu." />
            ...
            <p className='text-sm text-grey-200 pt-14 md:text-base lg:max-w-3xl lg:text-lg'>
